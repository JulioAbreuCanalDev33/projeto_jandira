...
--
-- Host: localhost:3306
-- Tempo de geração: 01/01/2025 às 14:38
...
INSERT INTO `cadastro_atletas` (`id`, `nome`, `rg`, `cpf`, `endereco`, `numero`, `cep`, `municipio`, `cidade`, `data_nascimento`, `email`, `telefone`, `data_cadastro`) VALUES
